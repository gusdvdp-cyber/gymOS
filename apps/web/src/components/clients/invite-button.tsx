...
import { createInvitation } from '@/app/(dashboard)/dashboard/clients/actions'
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          >
            <div className="flex items-center justify-between px-5 py-4" style={{ borderBottom: '1px solid #2a2a2a' }}>
              <p className="font-semibold" style={{ color: '#ffffff', fontFamily: 'var(--font-body)', fontSize: 14 }}>
                Invitación generada
              </p>
              <button
                type="button"
            ...
            <div className="p-5 space-y-4 text-center">
              {qrDataUrl ? (
                <div className="flex justify-center">
                  ...
                  <img
                    ...
                    style={{ border: '1px solid #2a2a2a', padding: 8 }}
                    width={220}
                    height={220}
                  />
                </div>
              ...
              <p style={{ color: '#444444', fontSize: 11, fontFamily: 'var(--font-mono)' }}>
                Válido 30 días · un solo uso
              </p>

              <div className="rounded-lg px-3 py-2 text-left" style={{ backgroundColor: '#1a1a1a', border: '1px solid #2a2a2a' }}>
                <p className="truncate" style={{ color: '#444444', fontSize: 11, fontFamily: 'var(--font-mono)' }}>
                  {inviteUrl}
                </p>
              </div>
